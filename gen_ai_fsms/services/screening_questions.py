...
screening_questions = [
    ...
    {
        "question_id": "q_chills_food",
        "text": "Do you keep any food chilled in fridges or chilled display units?",
        "sets_conditions": ["chills_food", "stores_or_displays_chilled_food"],
        "ask_if": None,
        "order": 1
    },
    {
    ...
    },
    {
        ...
        "text": "Do you cook shellfish such as prawns, mussels, scallops, crab, or lobster?",
