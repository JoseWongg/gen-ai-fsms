...
from gen_ai_fsms.schemas.daily_shift import (
    ...
    DailyShiftIncidentSummaryResponse,
...
from gen_ai_fsms.services.daily_shift_service import (
    end_daily_shift,
    get_active_shift_incident_summary,
...
@router.get(
    ...
    response_model=DailyShiftIncidentSummaryResponse,
)
def get_current_shift_incident_summary(
    db: Session = Depends(get_db),
    current_user: User = Depends(get_current_user),
):
    business_profile_id = get_current_business_profile_id(current_user)

    return get_active_shift_incident_summary(
        db=db,
        business_profile_id=business_profile_id,
    )
